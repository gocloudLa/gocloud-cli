...
- **Configure AWS SSO** profiles in `.aws/config` (one per environment plus `org`/`sec` when enabled), and optionally verify GitHub organization membership via the `gh` CLI.
